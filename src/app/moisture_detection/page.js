          ...
          <Container maxWidth="xl" disableGutters>
            ...
            >
              <Stack spacing={3} sx={{ maxWidth: 'md', mx: 'auto' }}>
                ...
                >
                  Optimize your seed storage with our portable IoT device and mobile app, providing real-time moisture readings and lab-based instructions to achieve optimal levels.
                </Typography>
          ...
          <Container maxWidth="xl">
            ...
            >
              <Box sx={{ textAlign: 'center', mb: 4 }}>
                ...
                >
                  See how our portable IoT device measures seed moisture and the app provides instant guidance based on lab data.
                </Typography>
              </Box>
              <Box
                component={motion.div}
              ...
              >
                ...
                <Box sx={{ textAlign: 'center', py: 3 }}>
                  ...
                  <Typography sx={{ color: '#4B5563', fontSize: '0.9rem', maxWidth: '90%', mx: 'auto' }}>
                    Watch our IoT device and app work together to measure moisture and provide corrective instructions.
                  </Typography>
                </Box>
              </Box>
            </motion.div>
          ...
          <Container maxWidth="xl">
            ...
            >
              <Box sx={{ textAlign: 'center', mb: 6 }}>
                ...
                >
                  A simple process to monitor and optimize seed moisture levels on the go
                </Typography>
              </Box>
              <Box
                sx={{
                ...
                {[
                  {
                    ...
                    description: 'Pair your portable device with the mobile app via Bluetooth',
                    ...
                    image: (
                      ...
                      >
                        <Box sx={{ textAlign: 'center' }}>
                          <SmartphoneIcon sx={{ fontSize: 40, color: '#9CA3AF', mb: 1 }} />
                  ...
                  },
                  {
                    ...
                    description: 'Place seeds in the device and get instant readings',
                    ...
                    image: (
                      ...
                      >
                        <Box sx={{ textAlign: 'center' }}>
                          <MoistureIcon sx={{ fontSize: 40, color: '#9CA3AF', mb: 1 }} />
                          <Typography sx={{ color: '#9CA3AF', fontSize: '0.85rem' }}>
        ...
        >
          ...
          <Container maxWidth="xl">
            ...
            >
              ...
              >
                Use our portable IoT device and app to ensure perfect moisture levels with expert guidance from lab data.
              </Typography>
