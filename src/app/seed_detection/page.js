          ...
          <Container maxWidth="xl" disableGutters>
            ...
            >
              <Stack spacing={3} sx={{ maxWidth: "md", mx: "auto" }}>
                ...
                >
                  Revolutionize your seed processing with our AI-powered system,
                  integrated with a custom-built sorting machine to detect and
                  remove wild or mixed seeds, ensuring unparalleled purity and
                  efficiency.
                </Typography>
          ...
          <Container maxWidth="xl">
            ...
            >
              <Box sx={{ textAlign: "center", mb: 4 }}>
                ...
                >
                  See how our AI-powered system analyzes seed images and
                  integrates with our custom sorting machine to deliver
                  high-purity seed batches.
                </Typography>
              </Box>
              <Box
                component={motion.div}
              ...
              >
                ...
                <Box sx={{ textAlign: "center", py: 3 }}>
                  ...
                  >
                    Watch our system detect and sort seeds with precision using
                    AI and our custom-built machine.
                  </Typography>
                </Box>
              </Box>
            </motion.div>
          ...
          <Container maxWidth="xl">
            ...
            >
              <Box sx={{ textAlign: "center", mb: 6 }}>
                ...
                >
                  A seamless process to ensure high-purity seed batches with AI
                  and automation
                </Typography>
              </Box>
              <Box
                ...
                {[
                  {
                    ...
                    description:
                      "Take a high-resolution photo of your seed batch on a white background",
                    icon: (
                  ...
                  },
                  {
                    ...
                    description:
                      "Our AI processes the image to detect wild or mixed seeds with precision",
                    icon: (
                  ...
                  },
                  {
                    ...
                    description:
                      "Our custom machine sorts seeds based on AI results for maximum purity",
                    icon: (
        ...
        >
          ...
          <Container maxWidth="xl">
            ...
            >
              ...
              >
                Leverage our AI-driven system and custom sorting machine to
                achieve unmatched seed purity and efficiency.
              </Typography>
              <Stack
                direction={{ xs: "column", sm: "row" }}
                spacing={2}
